...
const Header = () => {
  return (
    <header className="absolute top-0 left-0 right-0 z-50 bg-black/60 border-b border-gray-500/50 h-[80px] md:h-[98px]">
      <div className="max-w-[1440px] mx-auto h-full relative">
        <div className="flex items-center justify-between h-full px-4 md:px-6 lg:px-[122px]">
          ...
          {/* Actions - RIGHT - Positioned absolutely to match Figma */}
          <div className="hidden lg:flex items-center gap-[42px] absolute right-[81px] top-[31px]">
            ...
            <Button variant="whatsapp" icon={WhatsAppIcon} className="h-[35px]">
              Contactar
            </Button>
          </div>
          ...
          <div className="flex lg:hidden items-center gap-2">
            <Button variant="magenta" icon={ShoppingCart} className="h-[35px] text-xs">
              <span className="sm:hidden">Carrito</span>
            </Button>
            <Button variant="whatsapp" icon={WhatsAppIcon} className="h-[35px] text-xs">
