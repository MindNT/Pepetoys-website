...
const rawImages = import.meta.glob('/public/proyectosentregados/*.{jpg,jpeg,png,webp,gif}');
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-8">
            ...
            <div className="relative w-full max-w-[1400px] h-full max-h-[90vh] flex flex-col bg-white rounded-[24px] shadow-sm overflow-hidden border border-gray-100">
                ...
                <div className="flex-shrink-0 flex items-center justify-between p-5 md:p-6 border-b border-gray-100 bg-white">
                    <h2 className="text-[28px] md:text-3xl font-black text-[#B70F2A] uppercase tracking-wide font-['Inter']">Proyectos Entregados</h2>
                    <button 
                        onClick={onClose}
                    ...
                    {availableFilenames.length === 0 ? (
                        <div className="h-full flex flex-col items-center justify-center">
                            ...
                            <p className="text-gray-500 text-xl font-medium text-center max-w-md">
                                ...
                                <span className="text-sm mt-2 block opacity-80">Deposita cualquier cantidad de imágenes en la carpeta <span className="font-mono text-white/80">public/proyectosentregados/</span> y aparecerán aquí automáticamente (recarga requerida en pruebas).</span>
                            </p>
                        </div>
                    ) : (
...
export default ProyectosEntregadosModal;
